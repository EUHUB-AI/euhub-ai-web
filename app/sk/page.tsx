            ...
            <header className="fixed top-0 w-full z-50 glass-panel border-b border-white/5 bg-black/50">
                <div className="container mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href="/sk" className="text-sm font-medium text-white">SK</Link>
                        <Link href="/" className="text-sm font-medium text-gray-400 hover:text-white transition-colors">EN</Link>
            ...
            <main className="flex-grow pt-20">
                    ...
                    <div className="container mx-auto px-6 relative z-10 text-center">
                        ...
                        >
                            ...
                            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-white leading-tight">
                                Váš partner pre <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Implementáciu AI</span> <br />
                                v strednej Európe.
                            </h1>
                ...
                <section id="services" className="py-24 bg-black/50">
                    <div className="container mx-auto px-6">
                        <div className="mb-16">
                            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Enterprise-Grade AI Infraštruktúra</h2>
                            <p className="text-gray-400 max-w-xl">Komplexné riešenia pre moderné podnikanie. Od auditu až po plnú automatizáciu.</p>
                        </div>
                ...
                <section id="contact" className="py-24 relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        <div className="grid md:grid-cols-2 gap-16 items-center">
                            <div>
                                <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Nechajte technológie pracovať za vás</h2>
                            ...
                            <div className="relative">
                                ...
                                <div className="relative glass-panel p-8 md:p-10 rounded-3xl border border-white/10">
                                    <h3 className="text-2xl font-bold text-white mb-2">Získajte Audit Zadarmo</h3>
                                    <p className="text-gray-400 mb-8">Vyplňte formulár nižšie a náš tím vás bude kontaktovať do 24 hodín.</p>
                                    <ContactForm
                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                        <div className="text-center md:text-left">
                            ...
                            <p className="text-gray-500 text-sm">Váš partner pre digitálnu transformáciu <br />a automatizáciu na Slovensku.</p>
                        </div>

                        <div className="flex gap-8 text-sm text-gray-500">
                            <Link href="/sk/privacy" className="hover:text-white transition-colors">Politika súkromia</Link>
                            <Link href="/sk/terms" className="hover:text-white transition-colors">Obchodné podmienky</Link>
                            <Link href="/sk/cookie" className="hover:text-white transition-colors">Cookies</Link>
                        </div>
